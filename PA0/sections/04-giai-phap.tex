...
\begin{figure}[h]
    ...
    \begin{tikzpicture}[
        ...
        \node[smallbox] (deposit) at (5.0,-0.2) {Bảo chứng cọc\\xử lý hư hỏng/mất thiết bị};

        \draw[money] ([yshift=0.22cm]renter.east) -- ([yshift=0.22cm]platform.west)
            node[midway, above=0.12cm, note]{Truyền thống: cọc 100\% giá trị + phí thuê};
        \draw[money] ([yshift=-0.22cm]renter.east) -- ([yshift=-0.22cm]platform.west)
            node[midway, below=0.12cm, note]{Mutux: phí thuê + phí vay cọc nhỏ};
