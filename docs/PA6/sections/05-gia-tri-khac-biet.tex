...
\subsubsection{Khác với dịch vụ thuê PC gaming}
...
\subsubsection{Phân tích đối thủ cạnh tranh}
...
\paragraph{Showroom và chuỗi cửa hàng gaming gear}
...
\paragraph{Gaming center và tiệm net cao cấp}
...
\begin{itemize}
    ...
    % \begin{figure}[H]
    % \centering
    % \includegraphics[width=0.86\textwidth]{../PA2/img/ggaming.jpg}
...
% \paragraph{Review online trên YouTube, TikTok và cộng đồng}
...
\paragraph{Website cho thuê thiết bị công nghệ}
...
\paragraph{Shop bán gear hỗ trợ cho thuê gaming gear}
...
\paragraph{Marketplace và cộng đồng Facebook mua bán gaming gear}
...
\end{itemize}
\paragraph{Sàn thương mại điện tử và ứng dụng mua sắm}
...
\subsubsection{So sánh Mutux với các giải pháp hiện có}
...
\subsubsection{Các điểm khác biệt chính của Mutux}
