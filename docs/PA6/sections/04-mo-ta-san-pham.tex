...
% maybe người cho thuê cũng có thể là người thuê?
    ...
    \begin{itemize}
        ...
        \item \textbf{Cọc Trả Sau/hỗ trợ cọc}: người thuê không cần khóa trước toàn bộ tiền cọc mà chỉ trả phí thuê cộng với một khoản phí vay hoặc phí bảo chứng nhỏ nếu là giao dịch đầu tiên phát sinh trong tháng. Phần cọc vẫn được bảo chứng để xử lý rủi ro hư hỏng, mất thiết bị hoặc vi phạm điều kiện thuê.
    \end{itemize}
...
Sau khi người thuê được duyệt đăng ký làm người cho thuê, họ vừa có thể sử dụng các tính năng như người thuê, bổ sung thêm các tính năng của người cho thuê:
\begin{itemize}
...
\begin{itemize}
    \item Quản lý người dùng: cho phép admin xem hồ sơ, kiểm tra trạng thái, duyệt yêu cầu KYC và quản lý tài khoản người thuê, shop hoặc chủ gear.
