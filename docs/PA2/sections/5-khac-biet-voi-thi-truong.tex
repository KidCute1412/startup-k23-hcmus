...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.7\textwidth]{img/gearvn.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{img/ggear_2.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.86\textwidth]{img/quocdat.png}
    \caption{Website của Quốc Đạt Computer}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=0.86\textwidth]{img/ict.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.86\textwidth]{img/shopee.png}
    \caption{Shopee}
\end{figure}
...
\begin{table}[H]
    ...
    \resizebox{\textwidth}{!}{%
    \begin{tabular}{|p{4.1cm}|c|c|p{3.0cm}|c|c|c|c|}
        \hline
        \textbf{Tiêu chí} & \textbf{Showroom gear} & \textbf{Gaming center} & \textbf{\shortstack{Review TikTok/YouTube\\nền tảng chung}} & \textbf{Web thuê công nghệ} & \textbf{Sàn TMĐT} & \textbf{Group Facebook} & \textbf{Mutux} \\
        \hline
        Tập trung riêng vào gaming gear cá nhân & Có & Một phần & Có nội dung chuyên biệt, nhưng không phải dịch vụ thuê & Không phổ biến & Có & Có & Có \\
        \hline
        Đa dạng chuột, bàn phím, tai nghe, tay cầm & Có & Hạn chế & Có, dưới dạng video/bài viết tham khảo & Không phổ biến & Có & Có & Có \\
        \hline
        Thuê gaming gear cá nhân ngắn hạn & Không & Không & Không & Một phần & Không & Có, tự phát & Có \\
        \hline
        Mang thiết bị về dùng tại nhà & Không & Không & Không & Có & Có & Có nếu mua/thoả thuận & Có \\
        \hline
        Thử trước khi quyết định mua & Thử nhanh & Có tại chỗ & Không, chỉ xem cảm nhận từ reviewer/cộng đồng & Không rõ & Không & Không rõ & Có \\
        \hline
        Booking theo lịch từng thiết bị & Không & Không & Không & Một phần & Không & Không & Có \\
        \hline
        Lọc theo game, thông số và nhu cầu cá nhân & Một phần & Không & Phụ thuộc reviewer, thuật toán và cộng đồng & Không phổ biến & Một phần & Không & Có \\
        \hline
        Review sau trải nghiệm thuê nhiều ngày & Không & Không & Không, chủ yếu là review sau mua hoặc review ngắn hạn & Không phổ biến & Một phần & Không hệ thống & Có \\
        \hline
        Hiển thị lượt thuê và lịch sử sử dụng & Không & Không & Không & Không phổ biến & Không phải mô hình thuê & Không & Có \\
        \hline
        Quản lý bằng chứng giao nhận & Không & Không & Không & Một phần & Có & Không & Có \\
        \hline
        Giải quyết tranh chấp qua nền tảng & Không & Không & Không & Một phần & Một phần & Không & Có \\
        \hline
        Hỗ trợ cọc hoặc Cọc Trả Sau & Không & Không & Không & Không & Không & Không & Có \\
        \hline
        Kết nối nhiều người thuê và cho thuê mọi nơi & Không & Không & Không & Không & Không & Có, tự phát & Có \\
        \hline
        Người cho thuê là shop và cá nhân độc lập & Không & Không & Không & Không phổ biến & Không & Có & Có \\
        \hline
        Tạo thêm doanh thu từ gear nhàn rỗi & Một phần & Không & Gián tiếp qua quảng bá & Có & Không & Có, tự phát & Có \\
        \hline
        Dữ liệu tập trung về cảm giác sử dụng gear & Không & Không & Có nhưng phân tán theo kênh, reviewer và nền tảng & Không phổ biến & Có nhưng thường là khoảng thời gian ngắn sau khi nhận hàng & Phân tán & Có \\
        \hline
    \end{tabular}%
    }
    \renewcommand{\arraystretch}{1}
    \caption{So sánh Mutux với các giải pháp hiện có trên thị trường}
\end{table}
