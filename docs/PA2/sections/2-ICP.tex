...
\begin{itemize}
    ...
    \end{itemize}
    \item \textbf{Giải pháp từ \projectname{}:} Cung cấp hệ thống giao dịch trung gian an toàn tuyệt đối với quy trình xác thực KYC nhằm xác minh danh tính người dùng nghiêm ngặt, thanh toán ký quỹ (escrow) tạm giữ tiền cọc, và bộ quy chuẩn minh chứng bàn giao (proof) rõ ràng dưới sự hỗ trợ giải quyết tranh chấp từ Admin.
\end{itemize}
...
\begin{table}[H]
    ...
    \begin{tabular}{p{3.5cm}p{5.5cm}p{5.5cm}}
        ...
        \textbf{Giải pháp \projectname{}} & Cung cấp kênh tiếp thị và cho thuê tự động; gia tăng tỷ lệ bán nhờ cơ chế cho thuê thử trước. & Quy trình xác minh KYC (Know Your Customer) nhằm xác minh danh tính chặt chẽ; thanh toán tạm giữ (escrow); đối soát minh chứng (proof) và giải quyết tranh chấp. \\
        \bottomrule
    \end{tabular}
\end{table}
