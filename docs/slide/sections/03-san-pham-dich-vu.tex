...
\begin{frame}{Hành trình sử dụng}{Thuê thử trước, mua khi đã chắc}
  ...
  \begin{tikzpicture}[node distance=8mm and 12mm]
    \node[cookie accent node,minimum width=2cm] (a) {Khám phá};
    \node[cookie node,minimum width=2cm,right=of a] (b) {Đặt thuê};
    \node[cookie node,minimum width=2cm,right=of b] (c) {Dùng thật};
    \node[cookie node,minimum width=2cm,right=of c] (d) {Đánh giá};
    \node[cookie node,minimum width=2cm,right=of d] (e) {Mua / thuê lại};
