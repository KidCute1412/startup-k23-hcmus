...
async function main() {
  ...
  await prisma.user.createMany({
    data: [
      ...
      // Week 2 finance contract fixtures
      {
        ...
        phone: '0910000011',
        password_hash: '$2b$10$hashedpassword011',
      ...
      },
      {
        ...
        phone: '0910000012',
        password_hash: '$2b$10$hashedpassword012',
      ...
      },
      {
        ...
        phone: '0910000013',
        password_hash: '$2b$10$hashedpassword013',
        full_name: 'W2 Lender',
        cccd: '001099000013',
        rating: 5.0,
        total_reviews: 0,
      ...
      },
      {
        ...
        phone: '0910000014',
        password_hash: '$2b$10$hashedpassword014',
        full_name: 'W2 Admin',
        cccd: '001099000014',
        rating: 5.0,
        total_reviews: 0,
  ...
  await prisma.mutuxWallet.createMany({
    data: [
      ...
      },
      {
        ...
        outstanding_debt: 0,
        status: 'active',
        partner_ref_id: 'W2-CREDIT-001',
        approved_at: daysAgo(1),
        expired_at: daysFromNow(364),
      },
    ],
    skipDuplicates: true,
  })
  ...
  await prisma.creditTransaction.createMany({
    data: [
      ...
      { id: 'a2000000-0000-0000-0000-000000000002', mutux_wallet_id: '50000000-0000-0000-0000-000000000001', type: 'deposit_lock',   amount: 500000,  display_balance_before: 5000000, display_balance_after: 5000000, direction: 'out', ref_type: 'rental_order', ref_id: '80000000-0000-0000-0000-000000000002', note: 'Khoá cọc đơn MX-2024-0002',   status: 'success' },
      ...
      { id: 'a2000000-0000-0000-0000-000000000005', mutux_wallet_id: '50000000-0000-0000-0000-000000000003', type: 'deposit_lock',   amount: 1000000, display_balance_before: 8000000, display_balance_after: 8000000, direction: 'out', ref_type: 'rental_order', ref_id: '80000000-0000-0000-0000-000000000003', note: 'Khoá cọc đơn MX-2024-0003',   status: 'success' },
      { id: 'a2000000-0000-0000-0000-000000000006', mutux_wallet_id: '50000000-0000-0000-0000-000000000005', type: 'limit_granted', amount: 3000000, display_balance_before: 0,       display_balance_after: 3000000, direction: 'in',  ref_type: null,           ref_id: null,                                   note: 'W2 credit fixture limit granted', status: 'success' },
    ],
    skipDuplicates: true,
  })
